...
function _tk_scripts() {
	...
	// load jquert_te  css
	wp_enqueue_style( 'jquery-te-css', THEME_DIR_URI . '/includes/css/jquery-te-1.4.0.css' );
	// load jquert_te js
	wp_enqueue_script( 'jquery-te-js', THEME_DIR_URI . '/includes/js/jquery-te-1.4.0.min.js', array('jquery') );
    ...
    wp_enqueue_script('angularjs-sanitize', get_stylesheet_directory_uri() . '/node_modules/angular-sanitize/angular-sanitize.js');
    wp_enqueue_script('angularjs-cookies', get_stylesheet_directory_uri() . '/node_modules/angular-cookies/angular-cookies.js');
    wp_enqueue_script('angular-resource', get_stylesheet_directory_uri() . '/node_modules/angular-resource/angular-resource.js');
    wp_enqueue_script('angular-modal', get_stylesheet_directory_uri() . '/node_modules/angular-modal-service/dst/angular-modal-service.min.js');


    wp_enqueue_script('angular-upload', get_stylesheet_directory_uri() . '/node_modules/angular-file-upload/dist/angular-file-upload.min.js');

    //Load local scripts
    wp_enqueue_script('scripts', get_stylesheet_directory_uri() . '/js/scripts.js', array( 'angularjs', 'angularjs-route' ));
    wp_enqueue_script('services', get_stylesheet_directory_uri() . '/js/services.js', array( 'scripts' ));
    //Load local scripts
    wp_enqueue_style( 'local-css', THEME_DIR_URI . '/includes/css/style.css' );
